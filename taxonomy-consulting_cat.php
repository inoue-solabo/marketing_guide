...
<section class="o-mv is-lower">
  ...
  <div class="content">
  <?php if(is_tax('consulting_cat','magazine')): ?>
  <div class="content__inner">
    <h1>SEO・伴走コンサルティングの記事一覧</h1>
    <p>
      <span>Magazine</span>
    </p>
  </div>
  <?php elseif(is_tax('consulting_cat','works')): ?>
  <div class="content__inner">
    <h1>SEO・伴走コンサルティングの成功事例</h1>
    <p>
      <span>Case</span>
    </p>
  </div>
  ...
  <div class="p-archive__inner">
    <div class="p-archive__content">
      <?php
        ...
        $type = get_query_var( 'consulting_cat' );
        $args = array(
